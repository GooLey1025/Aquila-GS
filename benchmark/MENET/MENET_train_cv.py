...
MENET_DIRECTORY = SCRIPT_DIRECTORY
BENCHMARK_SOURCE = MENET_DIRECTORY / "src_benchmark"
...
@dataclass(frozen=True)
class TraitFoldJob:
    """One independently tuned MENET trait and outer-fold combination."""
...
class TraitFoldContext:
    """Spawn-safe inputs shared by MENET workers."""
...
def main() -> None:
    ...
    regression_traits = list(
        prepared.metadata.get("regression_tasks") or trait_names
    )
