...
```sh
aquila_data_cv.py --vcf ../case/705rice_0.03.full.all.impute.biallelic.vcf.gz --phenotype GSTP008.pheno --encoding-type diploid_onehot --variant-type snp --fold-mapping 705rice_nested_cv.json -o test --save-raw-genotype --overwrite
```
